...
const CommentListTable = ({ socket, comments, error, getAllComments }) => {
  useEffect(() => {
    getAllComments(0, 10);
  }, []);
            ...
            <>
              <div className="text-right">
                <button
                  ...
                  onClick={() => getAllComments(comments.length, 10)}
                >
                  Load more
                </button>
              </div>
...
export default connect(mapStateToProps, { getAllComments })(CommentListTable);
